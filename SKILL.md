---
name: newsnow-skill
description: "NewsNow hot news skill - based on ourongxing/newsnow, daily hotspot brief"
version: 1.0.0
author: lzylipu
license: MIT
platforms: [linux]
prerequisites:
  env_vars: [NEWSNOW_BASE_URL]
  services:
    - name: NewsNow
      url: https://github.com/ourongxing/newsnow
      description: "Self-hosted news aggregator API"
metadata:
  hermes:
